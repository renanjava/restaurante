			...
			<ul class="nav-right">
						...
						<li class="waves-effect waves-light">
							<div class="media">
								...
								<div class="media-body">
									<h5 class="notification-user"><%= request.getSession().getAttribute("nome-usuario") %></h5>
				...
				<li class="user-profile header-notification"><a href="#!"
					class="waves-effect waves-light"> <img
						...
						alt="User-Profile-Image"> <span><%= request.getSession().getAttribute("nome-usuario") %></span> <i
